...
const MatrixActions = () => {
  ...
  const verticallyReverse = () => {
    ...
    dispatch(changeTriangularMatrixState(utils.verticallyReverseMatrix(triangularMatrix)));
  }
  const transposeClockwise = () => {
    if (rows !== columns) {
      ...
      dispatch(changeTriangularMatrixState(utils.transposeMatrixClockwise(triangularMatrix)));
    }
  }
  const transposeCounterClockwise = () => {
    if (rows !== columns) {
      ...
      dispatch(changeTriangularMatrixState(utils.transposeMatrixCounterClockwise(triangularMatrix)));
    }
  }
